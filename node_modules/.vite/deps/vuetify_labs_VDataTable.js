...
import "D:/workspace/quan-ly-ho-so/node_modules/vuetify/lib/labs/VDataTable/VDataTable.css";

// node_modules/vuetify/lib/components/VTable/VTable.mjs
import "D:/workspace/quan-ly-ho-so/node_modules/vuetify/lib/components/VTable/VTable.css";
    ...
    useRender(() => {
      ...
      return createVNode(Fragment, null, [props.loading ? ((_a = slots.loading) == null ? void 0 : _a.call(slots)) ?? createVNode(VDataTableRow, {
        ...
        return createVNode(Fragment, null, [slots.item ? slots.item(slotProps) : createVNode(VDataTableRow, {
          ...
          "item": item
        }, slots), isExpanded(item) && ((_a2 = slots["expanded-row"]) == null ? void 0 : _a2.call(slots, slotProps))]);
      })]);
    });
    return {};
  }
...
import "D:/workspace/quan-ly-ho-so/node_modules/vuetify/lib/labs/VDataTable/VDataTableFooter.css";
