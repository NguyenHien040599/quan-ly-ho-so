        ...
        <v-window-item :transition="false" value="noidung" style="padding: 15px; border: 1px solid #DADADA; border-top: 0px;padding-left: 5px;">
          <v-row class="mx-0 my-0">
            ...
            <v-col cols="12" class="py-0 mb-10">
              ...
              <v-textarea
                v-if="dataForm['ChuyenRaNuocNgoai'] == true"
                class="flex input-form"
                rows="3"
                v-model="dataForm['ThongTin_ChuyenRaNuocNgoai']"
                solo
                dense
                hide-details="auto"
                clearable
                placeholder="Nhập thông tin chuyển dữ liệu cá nhân ra nước ngoài"
              ></v-textarea>
            </v-col>
            <v-col cols="12" class="py-0 mb-10">
              <div class="text-label">Tổ chức, cá nhân nhận dữ liệu cá nhân <span style="color: red">(*)</span></div>
              <v-textarea
                class="flex input-form"
                rows="3"
                v-model="dataForm['ThongTin_ChuyenRaNuocNgoai']"
                ...
                hide-details="auto"
                clearable
                placeholder="Nhập thông tin tổ chức, cá nhân"
                required
                :rules="[v => (v !== '' && v !== null && v !== undefined) || 'Thông tin bắt buộc']"
              ></v-textarea>
            </v-col>
